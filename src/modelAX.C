#include "../include/modelAX.H"


/*=============================================================================
  MODELAX(BOUNDARY *mp, BOUNDARY *bs) - constructor
  ============================================================================*/
MODELAX::MODELAX(BOUNDARY *mp, BOUNDARY *bs):MODELA(mp,bs){
...
/*=============================================================================
  ...
  bi is for the brightness function of MODELAX, mpi is for the
  ...
  e.g. bi[0] is a number which indicates which element of p to MODELAX
  ...
  ============================================================================*/
void MODELAX::pConfig(std::vector<int> bi, std::vector<int> mpi, 
		      std::vector<int> bsi){
...
/*=============================================================================
  ...
  ============================================================================*/
void MODELAX::setP(std::vector<double> pp){
  unsigned int i;
...
/*=============================================================================
  ...
  ============================================================================*/
std::vector<double> MODELAX::getP() const{
  int i;
  int n=bi.size();
  int imax=0;
