...
/*=============================================================================
  ...
  testFitModelAToMHDImage [-poisson <float>]
...
int main(int argc, char *argv[]){
  ...
  pp[0]=a1; pp[1]=b; pp[2]=c; pp[3]=d; pp[4]=a2;  
  model.setP(pp);
